...
const subtopicOptions = ["Select a subtopic", "Studs directed high"];

const scaleOptions = ["Select a scale", "0", "1", "2", "3", "4", "5", "6"];
  ...
  return (
    isOpen && (
      <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 bg-green-350 pb-1">
        <div className="p-3">
          <Input label="Season:" />
          <Select label="Topic:" options={topicOptions} />
        </div>
        <div className="p-3">
          ...
          <Select label="Subtopic:" options={subtopicOptions} />
        </div>
        <div className="p-3 ">
          <Input label="Team:" />
          <Select isScale label="Scale:" options={scaleOptions} />
        </div>
        ...
        <div className="pt-3 px-3 pb-1 flex flex-col relative">
          <div className="absolute inset-y-0 left-0 w-[1px] h-[90%] bg-white top-1/2 transform -translate-y-1/2"></div>
